...
- **Wallet Balance Check** — Query all token balances in one command. Shows native + all ERC20 holdings
- **Send After Swap** — Swap tokens and automatically send the result to any address in one request
...
"How much money do I have on Pharos?"
"Show my wallet balance on Pharos mainnet"
"Send 10 USDC to 0xABC123..."
"Transfer 0.5 PROS to 0xABC123... on mainnet"
"Swap 10 PROS to USDC and send to 0xABC123..."
"Convert 50 USDC to WPHRS and send to 0xABC123..."
```
